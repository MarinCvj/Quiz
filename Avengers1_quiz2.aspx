<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Avengers1_quiz2.aspx.cs" Inherits="Quiz_web.Avengers1_quiz2" %>
...
<body>
    <form id="form1" runat="server">      
        ...
        <div class="question w3-round-xlarge">
            <br /><br />
            <p> What was the name of Loki's army? </p><hr />
            <asp:RadioButtonList runat="server">
                <asp:ListItem runat="server" id="radioButton1" class="avengers1_1guess" Text="  Chitauri" />
                <asp:ListItem runat="server" id="radioButton2" class="avengers1_2guess" Text="  Parademons" />
                <asp:ListItem runat="server" id="radioButton3" class="avengers1_3guess" Text="  He had no army" />
            </asp:RadioButtonList>
